...
# We do not need an Api, we shall create a namespace, namspace is similar to a blueprint
...
class SignUp(Resource):
    ...
    def post(self):
        ...
        return make_response(jsonify({"message":f"User with username '{username}' created successfully"})), 201
